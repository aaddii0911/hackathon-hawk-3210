...
day30 = driver.find_element(By.XPATH, "/html/body/div[4]/div[2]/div[1]/table/tbody/tr[5]/td[5]")
day30.click()
time.sleep(2)
# Click on the dropdown
drop_down = driver.find_element(By.XPATH, "//div[@class='svg-file-icon svg-file-calendar']")
...
next = driver.find_element(By.XPATH, "/html/body/div[4]/div[2]/div[1]/table/thead/tr[1]/th[3]")
next.click()
